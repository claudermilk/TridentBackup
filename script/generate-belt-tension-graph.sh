...
outdir=/home/pi/printer_data/input_shaper
if [ ! -d "${outdir}" ]; then
    mkdir "${outdir}"
fi
...
## stolen from https://github.com/jscancella/ratos-configuration/blob/master/scripts/generate-belt-tension-graph.sh